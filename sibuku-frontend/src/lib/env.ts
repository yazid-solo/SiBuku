...
const RAW_API_BASE_URL = String(process.env.NEXT_PUBLIC_API_BASE_URL ?? "http://127.0.0.1:8000").trim();
const RAW_APP_URL = String(process.env.NEXT_PUBLIC_APP_URL ?? "http://localhost:3000").trim();
